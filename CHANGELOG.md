...
- **Baseline HTTP security headers** ([#255](https://github.com/ferro-labs/ai-gateway/issues/255)): all gateway responses now include `X-Content-Type-Options`, `X-Frame-Options`, `Referrer-Policy`, and `Permissions-Policy` headers to reduce exposure to common web-layer risks.
