...
observability:
  tracing:
    ...
    propagate_passthrough: true  # inject traceparent on /v1/* pass-through and fixed-target (/v1/responses, /v1/files, /v1/batches) forwards (default true)
