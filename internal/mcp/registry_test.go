...
reg := NewRegistry()
reg.RegisterConfig(MCPServerConfig{Name: "s1", URL: srv.URL, TimeoutSeconds: 5})
...
reg := NewRegistry()
reg.RegisterConfig(MCPServerConfig{Name: "finder", URL: srv.URL, TimeoutSeconds: 5})
...
reg := NewRegistry()
reg.RegisterConfig(MCPServerConfig{
Name:           "filtered",
URL:            srv.URL,
...
reg := NewRegistry()
reg.RegisterConfig(MCPServerConfig{Name: "idem", URL: srv.URL, TimeoutSeconds: 5})
reg.InitializeAll(context.Background(), nil)
...
reg := NewRegistry()
reg.RegisterConfig(MCPServerConfig{Name: "c1", URL: srv.URL, TimeoutSeconds: 5})
reg.InitializeAll(context.Background(), nil)
...
reg := NewRegistry()
reg.RegisterConfig(MCPServerConfig{Name: "alpha", URL: "http://a", TimeoutSeconds: 1})
reg.RegisterConfig(MCPServerConfig{Name: "beta", URL: "http://b", TimeoutSeconds: 1})
...
reg := NewRegistry()
reg.RegisterConfig(MCPServerConfig{Name: "bad", URL: srv.URL, TimeoutSeconds: 2})
