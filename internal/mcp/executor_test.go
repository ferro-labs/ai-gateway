...
reg := NewRegistry()
reg.RegisterConfig(MCPServerConfig{Name: "exec-srv", URL: srv.URL, TimeoutSeconds: 5})
...
reg := NewRegistry()
reg.RegisterConfig(MCPServerConfig{Name: "err-srv", URL: srv.URL, TimeoutSeconds: 5})
